...
# # Association table for reviews (assuming it's a many-to-many relationship)
...
#     # SerializerMixin will handle basic serialization
...
#     # SerializerMixin helps to serialize this model to dict
...
#     # SerializerMixin handles serialization to dict
